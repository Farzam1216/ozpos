...
<div class="d-none">
    <div class="bg-primary p-3 d-flex align-items-center">
        ...
        <h4 class="font-weight-bold m-0 text-white">Resturants</h4>
    </div>
</div>
    ...
    <div class="container">
        <div class="most_popular py-5">
            <div class="d-flex align-items-center mb-4">
                <h3 class="font-weight-bold text-dark mb-0">Resturants</h3>
                <a href="#" data-toggle="modal" data-target="#exampleModal" class="ml-auto btn btn-primary">Filters</a>
            </div>
            <div class="row">
                    ...
                    <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm grid-card">
                        ...
                        <div class="p-3 position-relative">
                            <div class="list-card-body">
                                <h6 class="mb-1"><a href="/resturant" class="text-black">The osahan Restaurant
                             </a>
                                </h6>
