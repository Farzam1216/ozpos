                                                    ...
                                                    <form class="">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6 form-group">
                                                                ...
                                                                <input placeholder="Enter Mobile Number..." v-model="mobile" type="number" class="form-control">
                                                            </div>
                                                            <div class="col-md-12 form-group">
                                                                <label class="form-label">Table Number</label>
                                                                <select v-model="tableNumber" class="form-control" name="" id="">
...
export default {
  ...
  methods: {
    ...
    getVendorDetails() {
      axios
        ...
        //   this.tables = response.data.data.tables
           response.data.data.tables.forEach(tables => {
                 this.tables.push(tables.booked_table_number);
          });
        //   for (var input = 1; input <= response.data.data.vendor.total_tables_number; input++) {
    ...
    payment() {
      ...
      if(!this.tableNumber ){
        this.errors.push("Please Select Table Number.");
      }
