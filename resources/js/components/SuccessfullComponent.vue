    ...
    <div class="py-5 osahan-coming-soon d-flex justify-content-center align-items-center">
        <div class="col-md-6">
            <div class="text-center pb-3">
                ...
                <p>Check your order status in <a href="my-order" class="font-weight-bold text-decoration-none text-primary">My Orders</a> about next steps information.</p>
            </div>
            <!-- continue -->
            <div class="bg-white rounded text-center p-4 shadow-sm">
                ...
                <a href="my-order" class="btn rounded btn-primary btn-lg btn-block">Track My Order</a>
            </div>
        </div>
    </div>
    </div>
